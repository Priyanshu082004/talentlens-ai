    ...
    >
      <div className="glass rounded-2xl p-6 w-full max-w-sm mx-auto animate-float">
        ...
        <div className="mt-4 pt-4 border-t border-slate-200">
          <p className="text-xs text-slate-500 mb-2">Top suggestions</p>
          {['Add TypeScript to skills', 'Quantify impact metrics', 'Include GitHub link'].map((s) => (
            <div key={s} className="flex items-center gap-2 text-xs text-slate-600 mb-1.5">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full relative z-10 py-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="hero-headline font-display text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
            ...
            <p className="hero-sub text-lg text-slate-600 mb-8 leading-relaxed max-w-lg">
              {COPY.HERO.SUB}
            </p>
            ...
            <p className="hero-cta mt-5 text-xs text-slate-500">{COPY.HERO.TRUST_NOTE}</p>
          </div>
