  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <button className="md:hidden text-gray-400 hover:text-white" onClick={() => setMobileOpen((p) => !p)}>
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            {NAV_LINKS.map((l) => (
              <a key={l.label} href={l.href} className="text-sm text-gray-300 py-1" onClick={() => setMobileOpen(false)}>
                {l.label}
              </a>
            ))}
